// 语音日记 (voice diary) entries (source: prototype line ~3306, `DIARY_ENTRIES`;
// plus the recorder's seed entry at ~3646).
...
/**
 * Seed entry appended when the user finishes recording "today" (2026-07-23).
 * Source: `finishRec` (~line 3646). `duration` is dynamic in the prototype and
 * defaults to '0:42'.
 */
export const DIARY_RECORDED_ENTRY: DiaryEntry = {
  date: '2026-07-23',
  label: '7月23日 · 周四',
  emoji: '😌',
  emotion: '平静中带一点犹豫',
